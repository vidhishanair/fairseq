...
from fairseq.models.bart.structured_attention import StructuredAttention
...
@register_model("structsum_transformer")
class StructSumTransformerModel(FairseqEncoderDecoderModel):
    """
...
@register_model_architecture("structsum_transformer", "structsum_transformer")
...
# @register_model_architecture("structsum_transformer", "structsum_transformer_iwslt_de_en")
