...
def collate(
    ...
    src_sent_ids = src_sent_ids.index_select(0, sort_order)
...
class StructSumDataset(FairseqDataset):
    """
    ...
    def __getitem__(self, index):
        ...
        src_sent_id_item = self.src_sent_ids[index]
        ...
        if self.append_bos:
            ...
            if self.src[index][-1] != bos:
                ...
                src_sent_id_item = torch.cat([torch.LongTensor([self.src[index][0]]),
                                              self.src[index]])
        ...
        if self.remove_eos_from_source:
            ...
            if self.src[index][-1] == eos:
                ...
                src_sent_id_item = self.src_sent_ids[index][:-1]
        ...
        Returns:
            dict: a mini-batch with the following keys:
                ...
                - `net_input` (dict): the input to the Model, containing keys:
                  ...
                  - `src_sent_mask` (LongTensor): a padded 3D Tensor of sent mask in
                    the source sentence of shape `(bsz, src_sent_len, src_word_len)`. Padding will
                    appear on the left if *left_pad_source* is ``True``.
    ...
    def supports_prefetch(self):
        return (
                ...
                and getattr(self.src_sent_ids, 'supports_prefetch', False)
                and (getattr(self.tgt, 'supports_prefetch', False) or self.tgt is None)
        )

    def prefetch(self, indices):
        self.src.prefetch(indices)
        self.src_sent_ids.prefetch(indices)
